  var arr = [["Calories","cal",2000,,349,105,257,102,111,42],
			...
			var arr1 = [["Calories","cal",2000,,349,105,257,102,111,42, "Chicken Breast"],
			["Protein","g",50,,25.71,1.29,4.4,8.22,1.19,5.16, "Chicken Breast"],
			["Fat","g",65,,16.41,0.39,18,2.37,0.5,0.72, "Raspberries"],
			["Fiber","g",25,,3.4,3.1,0.3,0,26.76,0.72, "Raspberries"],
			["Calcium","mg",1000,,188,6,41,305,1,180, "Sardines"],
			["Iron, Fe","mg",18,,1.76,0.31,0.5,0.07,8.01,4.86, "Spinach"],
			["Magnesium, Mg","mg",400,,0,32,9,27,2,144, "Spinach"],
			["Potassium, K","mg",3500,,785,422,72,3366,23,1167, "Sweet Potatoes"],
			["Sodium, Na","mg",2400,,742,1,350,107,140,144, "Sweet Potatoes"],
			["Zinc, Zn","mg",15,,0,0.18,0.41,1.02,0.04,0.96, "Lamb"],
			["Vitamin C","mg",60,,30.9,10.3,0.3,0,7.3,50.4, "Guava"],
			["Vitamin, B-6","mg",2,,0,0.433,0.042,0.09,1.072,0.348, "Tuna"],
			["Vitamin, B-12","µg",6,,0,0,0.14,1.15,2.43,0, "1% Lowfat Milk"],
			["Vitamin A, IU","IU",5000,,7917,76,127,478,468,16878, "Liver"],
			["Vitamin E (alpha-tocopherol)","mg",20,,0,0.12,438,0.02,0.02,3.66, "Sunflower seeds"],
			["Vitamin D" ,"IU",400,,0,0,14,117,53,0, "Tofu"],
			["Vitamin K (phylloquinone)" ,"µg",80,,0,0.6,3.5,0.2,0.1,869.4, "Scallions"]];
   ...
   for (x = 1; x<18; x++){
		updateProgress(x, window.nutrients[x-1]);
			...
			display();
				...
				$("#panels > div:not(#second)").hide();
				$("#second").show();
				
			});
			$("#switchRec").click(function(){
				$("#panels > div:not(#recPanel)").hide();
				$("#recPanel").show();
				for(x = 1; x < 17; x++){
					if (nutrients[x]/arr1[x][2] < .2)
						{
							if(x==2)
								continue;
							else
								$("#recPanel").append("<li>" + arr1[x][0] + ": " + arr1[x][10] + "</li>");
						}
				}
			});
